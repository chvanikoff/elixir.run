defmodule ER.Web.Endpoint do
  use Phoenix.Endpoint, otp_app: :elixir_run

  socket "/socket", ER.Web.UserSocket
  ...
  def init(_key, config) do
    if config[:load_from_system_env] do
      port = System.get_env("PHX_PORT") || raise "expected the PORT environment variable to be set"
